...
# 
# Exchel, quería tomarme este tiempo al inicio de tu proyecto para comentarte mis apreciaciones generales de esta iteración de tu entrega.
# 
# Antes que nada quería darte la bienvenida al mundo de los datos, te deseo lo mejor y espero que consigas lograr tus objetivos. Personalmente me gustaría brindarte el siguiente consejo, "Está bien equivocarse, es normal y es lo mejor que te puede pasar. Aprendemos de los errores y eso te hará mejor programando ya que podrás descubrir cosas a medida que avances y son estas cosas las que te darán esa experiencia para ser un gran Data Scientist."
#     
# Ahora si yendo a esta notebook. Te quiero felicitar porque has resuelto todos los ejercicios correctamente, destaco tu manejo sobre python y pandas a la hora de implementar tus lógicas para resolver los problemas. Este trabajo está en condiciones de ser aprobado Exchel! Bien hecho!
#     
# Éxitos en tu camino dentro del mundo de los datos! Saludos!
# </div>
...
# 2, 3.
# Seleccioné la opción 2 ya que el tener los espacios innecesarios puede presentar un problema a futuro, se debería escribir el string utilizando mayúsculas, minúsculas y un solo espacio separando nombre y apellido.
# La opción número 3 me parece un problema ya que es innecesario utilizar decimales cuando hablamos de la edad de una persona, será más eficiente utilizar un número entero.
# 
...
# 
# Excelente Exchel! Has respondido 2 de las 3 situaciones que eran correctas, a la vez has justificado correctamente también. Felicitaciones! La tercera respuesta correcta era la número 4, siempre es una buena práctica convertir a minúscula los valores.</div>
...
# <b>Comentario del revisor. (Iteración 1) </b> <a class="tocSkip"></a>
# 
# Muy bien Exchel, aplicaste correctamente ambos métodos. Si deseas puedes optimizar tu código (opcional) apilando ambos métodos en una misma línea de código.
# </div>
...
# <b>Comentario del revisor. (Iteración 1) </b> <a class="tocSkip"></a>
# 
# Muy bien hecho! Una implementación perfecta del método **try and except**.
# </div>
...
# <b> Comentario del revisor. (Iteración 1) </b> <a class="tocSkip"></a>
# 
# Excelente! Celda perfecta, Has podido resolver correctamente lo solicitado implementando un loop y métodos aplicados como **append(lower())**
# </div>
...
# <b>Comentario del revisor. (Iteración 1)</b> <a class="tocSkip"></a>
# 
# Impecable! Así es como se debe realizar! Muy bien resuelto Exchel!
# </div>
...
print(young_users)# escribe tu código aquí


# <div class="alert alert-block alert-success">
# <b>Comentario del revisor. (Iteración 1) </b> <a class="tocSkip"></a>
# 
# Bien resuelto, felicitaciones! En este caso has resuelto el problema muy bien, buena implementación del loop junto al condicionante. Bien hecho!
# </div> 
...
for user in users:
    if user[2] < 30 and sum(user[-1]) > 1000:
        special_users.append(user[1])
        
print(special_users)# escribe tu código aquí


# <div class="alert alert-block alert-success">
# <b>Comentario del revisor. (Iteración 1)</b> <a class="tocSkip"></a>
# 
# Excelente resolución! Has implementado tanto el loop con un doble condicionante en la misma línea de código para así luego exponer el resultado. Sigamos!
# </div>
...
for user in users:
    ...
    for category in categories:
        if 'clothes' in category:
            clothes_users.extend(user[1]) 
            clothes_users.append(user[2])
...
# <b>Comentario del revisor. (Iteración 1)</b> <a class="tocSkip"></a>
# 
# Excelente Exchel, has implementado un doble loop que era el objetivo de este ejercicio. Para mejorar la muestra de los resultados podríamos implementar sub-índices, te invito a investigarlo.
# </div>

# Me está gustando muchísmo aprender, espero que no haya correcciones, y si las hay, seguiré esforzándome para mejorar.
